...
public class main : MonoBehaviour
{
    ...
    public GameObject gameOverGameObeject1;

    public GameObject iAmRdyButton;
    ...
    void Start()
    {
        ...
        gameOverGameObeject1.SetActive(false);
        iAmRdyButton.SetActive(false);
        camerae = Camera.main;
    ...
    public void tcp() 
    {
        ...
        while (true) 
        {
            while (true)
            {
                ...
                if (scheck.Contains("$") || scheck.Contains("&") || scheck.Contains("@") || scheck.Contains("%") || scheck.Contains("*") || scheck.Contains("!") || scheck.Contains("#"))
                {
                ...
                else
                {
                    ...
                    {
                        if (scheck.Split('-').Length == 4 && scheck.Split('-')[0].Contains(".onion") && scheck.Split('-')[0].Length == 22)
                        {
